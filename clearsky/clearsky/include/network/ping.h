#pragma once
#ifndef _CLEARSKY_PING_H_
#define _CLEARSKY_PING_H
...
private:
  ...
  {
    if (num_replies_ == 0)
		LOG->logMsg(LT_STATUS, "Request timed out.");
  ...
  void handle_receive(std::size_t length)
  {
          ...
          && icmp_hdr.sequence_number() == sequence_number_)
    {
	  ...
	  LOG->logMsg(LT_STATUS, "%u bytes in %u ms", (length - ipv4_hdr.header_length()),
...
class CLEARSKY_API ping_thread
{
private:
